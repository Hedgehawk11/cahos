...
@Mod("cahos")
public class CahosMod {
	public static final Logger LOGGER = LogManager.getLogger(CahosMod.class);
	public static final String MODID = "cahos";
