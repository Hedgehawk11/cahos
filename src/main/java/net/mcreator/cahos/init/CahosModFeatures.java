...
public class CahosModFeatures {
	...
	public static final RegistryObject<Feature<?>> OH_HO_ORE = register("oh_ho_ore", OhHOOreFeature::feature, new FeatureRegistration(GenerationStep.Decoration.UNDERGROUND_ORES, OhHOOreFeature.GENERATE_BIOMES, OhHOOreFeature::placedFeature));
